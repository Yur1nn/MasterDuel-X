...
namespace YgomGame
{
    static unsafe class DeckEditViewController2
    {
        ...
        static void InitExtraTextComponent(IntPtr thisPtr)
        {
            ...
            MiniDuelClient.AssetHelper.Vector2 sizeDelta = new AssetHelper.Vector2(1000, 200);
            ...
            MiniDuelClient.AssetHelper.Vector2 anchorPos = new AssetHelper.Vector2(0, 0);
            rectTransformSetAnchoredPosition.Invoke(rectTransform, new IntPtr[] { new IntPtr(&anchorPos) });
            //MiniDuelClient.AssetHelper.Vector2 offsetMin = new AssetHelper.Vector2(0, -100);
