...
namespace MiniDuelClient
{
    static partial class ClientSettings
    {
        ...
        public static bool Load()
        {
            ...
            GameDirectory = Utils.ResolvePath(Program.CurrentDir, Utils.GetValue<string>(data, "GameDirectory", ".."));
            ServerExecutablePath = Utils.ResolvePath(Program.CurrentDir, Utils.GetValue<string>(data, "ServerExecutablePath", "MiniDuel.exe"));
        ...
        {
            // Each MiniDuel client needs its own proxy server, attempt to find a free port
