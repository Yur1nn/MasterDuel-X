...
namespace MiniDuelClient
{
    static partial class ClientSettings
    {
        ...
        /// MiniDuel
        /// </summary>
        public static string CustomTextMiniDuel;
        /// <summary>
        /// Error
        /// </summary>
        ...
        static bool LoadText()
        {
            ...
            CustomTextMiniDuel = Utils.GetValue<string>(data, "CustomTextMiniDuel", Utils.GetValue<string>(data, "CustomTextYgoMaster"));
