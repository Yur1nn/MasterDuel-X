                ...
                case "updatediff":// Dumps referenced enums / functions (use this to diff and update enums / funcs)
                    {
                        ...
                        using (TextWriter tw = File.CreateText("updatediff.cs"))
                        {
                            ...
                            tw.WriteLine("// This file is generated using the 'updatediff' command in MiniDuelClient. This information is used to determine changes between client versions which impact MiniDuel.");
                ...
                case "cardswithart":// List all cards with art (requires setup of YgoMaster/Data/CardData/)
                    {
                        ...
                        if (cardRarePtr != IntPtr.Zero)
                        {
                            ...
                            {
                                if (!cardRare.ContainsKey(card.Key.ToString()) && AssetHelper.FileExists("Card/Images/Illust/tcg/" + card.Key) && card.Value.Frame != MiniDuel.CardFrame.Token)
                                {
