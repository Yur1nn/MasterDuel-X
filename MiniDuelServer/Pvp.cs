...
namespace MiniDuel
{
    ...
    class Pvp
    {
        public const string DllName = "duel.dll";

        public static string GetDllPath()
        {
            return Utils.GetGameDuelDllPath(RuntimePaths.GameDirectory);
        }
        ...
        bool InitContent()
        {
            ...
            string dataRootDir = Utils.GetDataDirectory(true, Path.GetDirectoryName(RuntimePaths.ServerExecutablePath));
