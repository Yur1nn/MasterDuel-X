...
namespace MiniDuel
{
    ...
    class YgoDbSet
    {
        ...
        public static MiniDuel.CardRarity ConvertRarity(YgoDbSet.CardRarity rarity)
        {
            switch (rarity)
            {
                default:
                case CardRarity.Common:
                    return MiniDuel.CardRarity.Normal;
                case CardRarity.Rare:
                case CardRarity.HobbyCommon:
                    return MiniDuel.CardRarity.Rare;
                case CardRarity.SuperRare:
                    return MiniDuel.CardRarity.SuperRare;
                ...
                case CardRarity.PremiumGoldRare:
                    return MiniDuel.CardRarity.UltraRare;
            }
        }
